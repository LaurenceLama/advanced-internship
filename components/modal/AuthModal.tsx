        ...
        >
          {isForgotPass ? (
            <>
              <div className="pb-6 px-8 pt-12">
                ...
                >
                  ...
                  />
                  <button 
                  className="text-[#032b41] bg-[#2bd97c] w-full h-10 
                  rounded flex items-center justify-center min-w-[180px] 
                  duration-200 hover:bg-[#20ba68]"
                  disabled
                  >
              ...
              <button
                className="font-light w-full h-10 text-center bg-[#f1f6f4] 
                text-[#116be9] rounded-b hover:bg-[#e1e9e8]"
                onClick={() => {
            ...
            <>
              ...
              >
                {signup || isForgotPass ? null : "Forgot your password?"}
              </div>
